...
const Sidebar = () => {
	...
	<div class='sidebar'>
		...
		<form class='sidebar__form form' action=''>
			...
			<TextInput className='form__input form__input--75' label={{ en: 'Town', de: 'Ort', it: 'Città'}} name='town' id='town' value={form.town} onInput={(event) => handleTextInputUpdate(event, 'town')}/>
